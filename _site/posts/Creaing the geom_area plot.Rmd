---
title: "Creating the geom_area Plot"
output:
  html_document:
    toc: true
    toc_float: true
...
## Adding a year column (not needed)

```{r message = FALSE}
    # Adds year column from the date column
    counts_daily_filtered$year <- as.numeric(format(counts_daily_filtered$date, "%Y"))
