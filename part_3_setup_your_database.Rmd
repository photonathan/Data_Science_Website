...
So, instead of running the code above, I'll use the Python module *os* to import my *Environment Variables* **arlington_user** and **arlington_password** which wont be saved in this code, protecting my database credentials. 
