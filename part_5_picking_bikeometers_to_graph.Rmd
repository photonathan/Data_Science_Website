...
I'll outline two options to combine the 'I' and 'O' variables: using a MySQL Statement or using the R 'dplyr' package. 
...
Whether you use a MySQL Statement or 'dplyr' you can see the 'I' and 'O' directions are combined!
