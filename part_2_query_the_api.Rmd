...
Use Python to query the API and return the details of each Bikeometer and the number of bikers in a date range. With that information, create a pandas data frame.
...
We will organize all these parameters in a dictionary and pass that dictionary to the GET function.
...
To isolate the important information we can use the **get** function and pass in 'count', 'date', 'direction', or 'mode' to get the value.
