...
---
```{r setup, include=FALSE, cache=TRUE, autodep=TRUE, cache.lazy=FALSE}
...
```{python cache=TRUE, autodep=TRUE, cache.lazy=FALSE}
import requests
...
```{python eval=FALSE, cache=TRUE, autodep=TRUE, cache.lazy=FALSE}
response.text
```
