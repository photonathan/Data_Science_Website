...
We will us the method 'GetCountInDateRange', pass in the dates that we are looking for, and pull out the data that we want:

I'll use the 'requests' library to make a 'GET' request to the base Bike Arlington URL and pass in the 'GetAllCounters' method as a parameter.
