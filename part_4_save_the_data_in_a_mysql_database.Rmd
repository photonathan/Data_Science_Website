...
I've taken the the *get_bikeometer_details* function from Part 2 as well as the GET request steps and made them into a single function *bikeometer_to_sql*.
