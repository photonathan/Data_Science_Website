...
```
Because I ran the previous function today, the function returns 'No new data available'. Try it for yourself tomorrow and compare the time it takes to pull 1 day's worth of data compared to over 10 years worth of data.
