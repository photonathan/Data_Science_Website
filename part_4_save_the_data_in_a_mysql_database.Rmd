...
# Background
I will be building on the Python code we generated in [Part 2: Query the API]() to make the API calls and convert that data to a Pandas Data Frame.
...
# Steps
1. Create tables in MySQL to house our data
2. Move our data into MySQL
3. Add feature to check for existing data in the database
4. Add function that only pulls and adds new data to the database
5. 
