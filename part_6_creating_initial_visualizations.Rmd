...
```
```{r}
counts_daily_filtered_2020_grouped <- counts_daily_filtered_2020 %>% group_by(month_day) %>% summarise('2020_counts' = count)
...
Let's now join the 'counts_daily_filtered_2017_to_2019_grouped' and the 'counts_daily_filtered_2020' tables so we can graph them.
